...
insert into orders values(1, 1001, 2, 86, 2*86);insert into orders values(21, 1056, 10, 86, 10*29);insert into orders values(41, 1057, 2, 86, 2*45);
insert into orders values(2, 1002, 3, 86, 3*40);insert into orders values(22, 1065, 1, 86, 1*27);insert into orders values(42, 1052, 1, 86, 1*89);
insert into orders values(3, 1003, 4, 86, 4*57);insert into orders values(23, 1071, 2, 86, 2*87);insert into orders values(43, 1053, 2, 86, 2*62);
insert into orders values(4, 1004, 2, 86, 2*60);insert into orders values(24, 1075, 3, 86, 3*51);insert into orders values(44, 1100, 3, 86, 3*63);
insert into orders values(5, 1087, 1, 86, 1*21);insert into orders values(25, 1077, 5, 86, 5*30);insert into orders values(45, 1093, 2, 86, 2*58);
insert into orders values(6, 1001, 1, 86, 1*86);insert into orders values(26, 1039, 6, 86, 6*92);insert into orders values(46, 1023, 2, 86, 2*18);
insert into orders values(7, 1100, 6, 86, 6*63);insert into orders values(27, 1047, 4, 86, 4*36);insert into orders values(47, 1027, 1, 86, 1*62);
insert into orders values(8, 1012, 4, 86, 4*15);insert into orders values(28, 1089, 7, 86, 7*28);insert into orders values(48, 1049, 1, 86, 1*81);
insert into orders values(9, 1043, 8, 86, 8*21);insert into orders values(29, 1098, 9, 86, 9*65);insert into orders values(49, 1058, 4, 86, 4*70);
insert into orders values(10, 1034, 4, 86, 4*16);insert into orders values(30, 1099, 8, 86, 8*10);insert into orders values(50, 1059, 3, 86, 3*91);
insert into orders values(11, 1067, 3, 86, 3*84);insert into orders values(31, 1002, 2, 86, 2*40);insert into orders values(51, 1027, 6, 86, 6*62);
insert into orders values(12, 1087, 3, 86, 3*21);insert into orders values(32, 1001, 2, 86, 2*86);insert into orders values(52, 1065, 7, 86, 7*27);
insert into orders values(13, 1024, 3, 86, 3*66);insert into orders values(33, 1045, 1, 86, 1*64);insert into orders values(53, 1048, 4, 86, 4*60);
insert into orders values(14, 1098, 2, 86, 2*65);insert into orders values(34, 1054, 3, 86, 3*14);insert into orders values(54, 1084, 3, 86, 3*81);
insert into orders values(15, 1099, 1, 86, 1*10);insert into orders values(35, 1065, 9, 86, 9*27);insert into orders values(55, 1093, 9, 86, 9*53);
insert into orders values(16, 1009, 1, 86, 1*69);insert into orders values(36, 1079, 8, 86, 8*40);insert into orders values(56, 1014, 6, 86, 6*19);
insert into orders values(17, 1006, 2, 86, 2*50);insert into orders values(37, 1041, 5, 86, 5*20);insert into orders values(57, 1001, 5, 86, 5*86);
insert into orders values(18, 1005, 2, 86, 2*98);insert into orders values(38, 1042, 2, 86, 2*76);insert into orders values(58, 1018, 2, 86, 2*81);
insert into orders values(19, 1032, 4, 86, 4*92);insert into orders values(39, 1056, 1, 86, 2*29);insert into orders values(59, 1033, 1, 86, 1*34);
insert into orders values(20, 1056, 5, 86, 5*29);insert into orders values(40, 1057, 6, 86, 6*45);insert into orders values(60, 1061, 3, 86, 3*54);
...
insert into store_book values (3, 1086, 62);insert into store_book values (5, 1005, 84);insert into store_book values (6, 1039, 4); insert into store_book values (5, 1056, 32);
insert into store_book values (2, 1020, 6); insert into store_book values (3, 1051, 5);insert into store_book values (4, 1050, 81);insert into store_book values (8, 1081, 51);
insert into store_book values (7, 1020, 94);insert into store_book values (8, 1080, 27);insert into store_book values (5, 1089, 48);insert into store_book values (5, 1082, 89);
insert into store_book values (4, 1050, 97);insert into store_book values (5, 1004, 6);insert into store_book values (4, 1026, 16);insert into store_book values (1, 1079, 46);
insert into store_book values (8, 1027, 68);insert into store_book values (3, 1064, 27);insert into store_book values (8, 1037, 92);insert into store_book values (8, 1081, 95);
insert into store_book values (2, 1014, 26);insert into store_book values (7, 1039, 8);insert into store_book values (5, 1075, 33);insert into store_book values (5, 1010, 83);
insert into store_book values (1, 1073, 35);insert into store_book values (3, 1037, 26);insert into store_book values (6, 1084, 36);insert into store_book values (3, 1081, 31);
insert into store_book values (2, 1031, 43);insert into store_book values (3, 1057, 36);insert into store_book values (4, 1024, 86);insert into store_book values (2, 1055, 60);
insert into store_book values (6, 1053, 89);insert into store_book values (6, 1069, 33);insert into store_book values (1, 1018, 33);insert into store_book values (4, 1026, 11);
insert into store_book values (8, 1005, 67);insert into store_book values (7, 1056, 4);insert into store_book values (3, 1099, 43);insert into store_book values (7, 1016, 40);
insert into store_book values (7, 1027, 33);insert into store_book values (2, 1092, 55);insert into store_book values (5, 1016, 28);insert into store_book values (6, 1020, 58);
insert into store_book values (8, 1005, 16);insert into store_book values (6, 1005, 23);insert into store_book values (7, 1022, 45);insert into store_book values (7, 1036, 39);
insert into store_book values (4, 1066, 16);insert into store_book values (7, 1048, 73);insert into store_book values (4, 1009, 1);insert into store_book values (1, 1013, 94);
insert into store_book values (3, 1004, 50);insert into store_book values (6, 1073, 28);insert into store_book values (2, 1015, 63);insert into store_book values (6, 1068, 46);
insert into store_book values (6, 1078, 12);insert into store_book values (5, 1036, 45);insert into store_book values (1, 1088, 74);insert into store_book values (4, 1099, 50);
insert into store_book values (5, 1056, 38);insert into store_book values (4, 1048, 8);insert into store_book values (6, 1039, 59);insert into store_book values (6, 1020, 18);
insert into store_book values (1, 1009, 13);insert into store_book values (4, 1092, 4);insert into store_book values (3, 1038, 20);insert into store_book values (7, 1010, 94);
insert into store_book values (7, 1094, 10);insert into store_book values (4, 1020, 70);insert into store_book values (4, 1053, 90);insert into store_book values (1, 1044, 74);
insert into store_book values (2, 1070, 20);insert into store_book values (4, 1073, 41);insert into store_book values (2, 1062, 12);insert into store_book values (5, 1057, 100);
insert into store_book values (8, 1026, 72);insert into store_book values (3, 1038, 41);insert into store_book values (6, 1077, 50);insert into store_book values (7, 1007, 51);
insert into store_book values (5, 1066, 6);insert into store_book values (2, 1076, 20);insert into store_book values (7, 1050, 16);insert into store_book values (6, 1045, 90);
insert into store_book values (4, 1063, 20);insert into store_book values (4, 1079, 83);insert into store_book values (7, 1090, 98);insert into store_book values (8, 1076, 93);
insert into store_book values (6, 1041, 20);insert into store_book values (5, 1066, 42);insert into store_book values (4, 1053, 77);insert into store_book values (6, 1043, 15);
insert into store_book values (8, 1019, 98);insert into store_book values (1, 1076, 6);insert into store_book values (2, 1075, 21);insert into store_book values (1, 1055, 75);
insert into store_book values (1, 1050, 50);insert into store_book values (7, 1054, 58);insert into store_book values (7, 1025, 56);insert into store_book values (4, 1071, 32);
insert into store_book values (6, 1017, 88);insert into store_book values (3, 1094, 90);insert into store_book values (4, 1097, 7);insert into store_book values (2, 1088, 40);
insert into store_book values (7, 1022, 85);insert into store_book values (1, 1095, 55);insert into store_book values (7, 1017, 11);insert into store_book values (7, 1020, 66);
insert into store_book values (4, 1094, 15);insert into store_book values (7, 1086, 96);insert into store_book values (1, 1054, 76);insert into store_book values (2, 1073, 56);
insert into store_book values (1, 1087, 10);insert into store_book values (6, 1100, 43);insert into store_book values (6, 1073, 10);insert into store_book values (4, 1090, 89);
insert into store_book values (6, 1022, 82);insert into store_book values (4, 1100, 69);insert into store_book values (8, 1069, 94);insert into store_book values (8, 1027, 98);
insert into store_book values (3, 1058, 2);insert into store_book values (8, 1079, 74);insert into store_book values (2, 1038, 18);insert into store_book values (4, 1005, 79);
insert into store_book values (8, 1020, 62);insert into store_book values (6, 1069, 67);insert into store_book values (5, 1044, 42);insert into store_book values (3, 1020, 58);
insert into store_book values (5, 1071, 43);insert into store_book values (1, 1010, 40);insert into store_book values (6, 1060, 32);insert into store_book values (2, 1007, 46);
insert into store_book values (8, 1020, 68);insert into store_book values (6, 1048, 56);insert into store_book values (7, 1001, 10);insert into store_book values (3, 1094, 55);
insert into store_book values (8, 1063, 77);insert into store_book values (8, 1086, 91);insert into store_book values (6, 1071, 45);insert into store_book values (6, 1053, 36);
insert into store_book values (3, 1024, 51);insert into store_book values (2, 1051, 42);insert into store_book values (1, 1097, 32);insert into store_book values (4, 1038, 80);
insert into store_book values (5, 1032, 89);insert into store_book values (6, 1026, 84);insert into store_book values (6, 1051, 96);insert into store_book values (3, 1020, 78);
insert into store_book values (1, 1058, 50);insert into store_book values (5, 1092, 42);
